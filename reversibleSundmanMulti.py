...
def G(lpFun,q,p,g):
    ...
    return((g/(b**2*(1.0+(g/b)**2)))*Hp)




def integrate(lpFun,q0,p0,rho0,h=0.01,nstep=1000):
...
def integrateREL(lpFun,q0,p0,rho0,h=0.0001,nstep=10000):
...
d = 2
lp = td.funnel1 # td.corrGauss #  td.modFunnel #    td.funnel1 # 

q0 = np.array([1.0,1.1]) # np.random.normal(size=d) # 
...
(q1,p1,rho1) = integrate(lp,q0,p0,rho0)

(q0b,p0b,rho0b) = integrate(lp,q1,-p1,rho1)
